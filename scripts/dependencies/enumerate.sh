...
#   'assert_equal'" will be generated.  This is normal; the snakefood utility
...
#   it couldn't find in the current PYTHONPATH.
#
############################################################################
...
ROOTS=cms/djangoapps:common/djangoapps:lms/djangoapps
