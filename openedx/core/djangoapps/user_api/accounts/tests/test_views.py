    ...
    def _retirement_to_dict(self, retirement, all_fields=False):
        ...
        retirement_dict = {
            ...
            u'user': {
                ...
                u'first_name': retirement.user.first_name,
                u'last_name': retirement.user.last_name
            },
            u'original_username': retirement.original_username,
            u'original_email': retirement.original_email,
            u'original_first_name': retirement.original_first_name,
            u'original_last_name': retirement.original_last_name,
