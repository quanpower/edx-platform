...
class UserRetirementStatus(TimeStampedModel):
    ...
    original_first_name = models.CharField(max_length=30, blank=True)
    # last_name max_length goes from 30 to 150 in Django 2.0; starting there to save a later migration headache
    original_last_name = models.CharField(max_length=150, blank=True)
