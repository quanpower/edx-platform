...
@enterprise_is_enabled()
def cache_enterprise(customer):
    """Cache this customer's data."""
    cache_key = get_enterprise_customer_cache_key(customer['uuid'])
    cache.set(cache_key, customer, settings.ENTERPRISE_API_CACHE_TIMEOUT)
